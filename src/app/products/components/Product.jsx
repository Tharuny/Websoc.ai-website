      ...
      <div className="overflow-hidden">
        ...
        >
          <section className="skill-set px-12 w-screen h-[100vh] bg-transparent ns-horizontal-section__item flex items-center z-50">
            ...
            <div className="m-auto text-9xl ourClients">our <br /> clients</div>
          </section>

          <section className="skill-set px-12 w-screen h-[100vh] bg-transparent ns-horizontal-section__item flex items-center z-50">
            <div className="blockline w-3 h-[100%]"></div>
            <div className="blockdiv w-[50%] h-[100%]"></div>
            <div className="m-auto text-9xl client-name"><p>labl</p></div>
          </section>
          <section className="skill-set px-12 w-screen h-[100vh] bg-transparent ns-horizontal-section__item flex items-center z-50">
            <div className="blockline w-3 h-[100%]"></div>
            <div className="blockdiv w-[50%] h-[100%]"></div>
            <div className="m-auto text-8xl client-name"><p>path</p></div>
          </section>
          <section className="skill-set px-12 w-screen h-[100vh] bg-transparent ns-horizontal-section__item flex items-center z-50">
            <div className="blockline w-3 h-[100%]"></div>
            <div className="blockdiv w-[50%] h-[100%]"></div>
            <div className="m-auto text-8xl client-name"><p>lucid</p></div>
          </section>
        </div>
      </div>
    </div>
